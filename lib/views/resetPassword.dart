...
class _ResetPasswordState extends State<ResetPassword> {
  ...
  TextEditingController _passwordControllerConfirm = new TextEditingController();
                ...
                Container(
                    child: SizedBox(
                      ...
                      Padding(
                        ...
                        child: Image.asset('assets/icons/souscription/shield.png', width: wv * 50,  /*
                      height: hv*10,*/),
                      )),
                    )
                ),
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: <Widget>[
                            Text(DemoLocalizations.of(context).trans('par_mesure_de_securite'), style: TextStyle(fontSize: 15.0,
                                color: Color(0xff191934),
                                fontWeight: FontWeight.bold)),
                          ],
                        ),
                        Text(DemoLocalizations.of(context).trans('mdpUpperCase'), style: TextStyle(fontSize: 15.0,
              ...
              child: Form(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    // Champ de texte du mot de passe de confirmation
                    CustomPasswordField(
                      hintText: DemoLocalizations.of(context).trans('mdp_confirm'),
                      keyboardType: TextInputType.text,
                      controller: _passwordControllerConfirm,
                      onSavedFunc: (value) => userPassword = value,
                      emptyValidatorText: DemoLocalizations.of(context).trans('mdp_confirm'),
                      validator: _passwordFieldValidator,
                      color: Colors.black45,
                    ),
