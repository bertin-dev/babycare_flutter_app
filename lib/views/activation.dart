                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Row(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: <Widget>[
                            Text("UDA", style: TextStyle(fontSize: 20.0,
                                color: Color(0xff191934),
                                fontWeight: FontWeight.bold)),
                            Text(" a envoyé un ", style: TextStyle(fontSize: 15.0,
                                color: Color(0xff191934),
                                fontWeight: FontWeight.bold)),
                            Text(" CODE ", style: TextStyle(fontSize: 15.0,
                                color: Color(0xffe8551b),
                                fontWeight: FontWeight.bold)),
                            Text("au", style: TextStyle(fontSize: 15.0,
                                fontWeight: FontWeight.bold)),
                          ],
                        ),
                        Text("numéro de téléphone ", style: TextStyle(fontSize: 15.0,
                            fontWeight: FontWeight.bold)),
              ...
              child: Form(
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    CustomPasswordField(
                      hintText: 'Entrez le code d\'activation',
                      keyboardType: TextInputType.text,
                      controller: _passwordController,
                      onSavedFunc: (value) => userPassword = value,
                      emptyValidatorText: 'Entrez votre code d\'activation',
